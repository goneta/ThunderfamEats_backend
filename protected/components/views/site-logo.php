<div class="<?php echo isset($class_name)?$class_name:''?>">
   <a href="<?php echo Yii::app()->getBaseUrl(true);?>">
     <?php if(strpos((string)(isset($class_name)?$class_name:''), 'top-logo') !== false && Yii::app()->user->isGuest):?>
      <?php /* Guests see the ThunderfamEats wordmark logo (brand image on black; rounded to read as a chip on any nav). Logged-in users keep the square logo icon below. */ ?>
