...
class COrders
{
    ...
    public static function orderMeta($meta_name=array('latitude','longitude','address1','street_number',
    ...
    public static function orderInfo($lang=KMRS_DEFAULT_LANGUAGE,$datenow='',$is_notifications=false)
    {
    	if(COrders::$order){
    		...
    		$attr = self::orderMeta(array(
			  ...
			  'timezone','street_number','custom_field1','custom_field2','payment_name','formattedAddress','order_version',
			  'formatted_address'
    		));				
