  ...
  public function actionregisterUser()
	...
	{					
		...
		if($model->validate() && $model->login() ){
			...
			$this->msg = t("Login successful");
			$this->details = array(
			  //'user_token'=>Yii::app()->user->logintoken,
  ...
  public function actionorderHistory()
	{	     
	     try {
	     	  ...
	     	  $offset = 0; $show_next_page = false;
	     	  $limit = Yii::app()->params->list_limit;			  
	     	  $total_rows = COrders::orderHistoryTotal(Yii::app()->user->id,Yii::app()->merchant->id);    	
			  ...
			  $data = COrders::getOrderHistory(Yii::app()->user->id,$q,$offset,$limit,Yii::app()->language,Yii::app()->merchant->id);			 			  
