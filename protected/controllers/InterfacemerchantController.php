...
class InterfacemerchantController extends InterfacemerchantCommon
{
    ...
    public function actiongetAttributes()
    {
        try {
            ...
            $this->details = [
                ...
                'delivery_zone_type'=>(array)CommonUtility::ArrayToLabelValue(AttributesTools::zoneType()),
    ...
    public function actionorderDetails($message='')
    {
        try {
             ...
             $origin_latitude = isset($merchant_info['latitude'] )?$merchant_info['latitude']:'' ;
             $origin_longitude = isset($merchant_info['longitude'] )?$merchant_info['longitude']:'' ;
            ...
            $map_direction = CMerchantListingV1::mapDirection($maps_config_raw, $order['order_info']['latitude'], $order['order_info']['longitude']);
            $delivery_direction = isset($map_direction)?$map_direction:'';
            ...
            if(in_array('driver',$payload)){
                ...
                if($order_type=="delivery" || $order_type=="bt"){
            ...
            try {
                $printer_details = CMerchants::getPrinterAutoPrinter($merchant_id,['bluetooth']);                 
            } catch (Exception $e) {}
		    ...
		    $data = array(
               ...
               'buttons'=>$buttons,
               'map_direction'=>$delivery_direction,
    ...
    public function actiongetInformation()
    {
        try {
            ...
            $this->details = [
                ...
                'delivery_zone_covered'=>$model->delivery_zone_covered,
                'latitude'=>$model->latitude,
                'lontitude'=>$model->lontitude,
                'delivery_zone_type'=>$model->delivery_zone_type,
    ...
    public function actionupdateInformation()
    {
        try {
            ...
            if($model){
                ...
                $model->delivery_zone_type = isset($this->data['delivery_zone_type'])?$this->data['delivery_zone_type']:'';
                $model->delivery_zone_covered = isset($this->data['delivery_zone_covered'])?$this->data['delivery_zone_covered']:'';
                if($model->save()){
                    $this->code = 1;
    ...
    public function actionPrintersList()
    {
        try {
			...
			$criteria->condition = "merchant_id=:merchant_id AND  device_uuid=:device_uuid AND b.meta_name=:meta_name AND platform=:platform";
			$criteria->params  = array(
			':merchant_id'=>$merchant_id,
            ':platform'=>'merchant',
