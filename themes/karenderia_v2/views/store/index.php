  ...
  <div class="container-fluid" id="main-search-banner">
    <div class="tf-banner">
      ...
      <div class="tf-cat-grid">
        <a href="<?php echo $tfSvc('home_services')?>" class="tf-cat tf-cat-green"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M3 11l9-7 9 7"/><path d="M5 10v10h14V10"/></svg></span><b><?php echo $tfFr?'Services à domicile':'Home Services'?></b></a>
        <a href="<?php echo $tfSvc('barber')?>" class="tf-cat tf-cat-blue"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><circle cx="6" cy="6" r="2.6"/><circle cx="6" cy="18" r="2.6"/><path d="M20 4L8.7 15.3M20 20L8.7 8.7"/></svg></span><b><?php echo $tfFr?'Barber':'Barber'?></b></a>
        <a href="<?php echo $tfSvc('hairdresser')?>" class="tf-cat tf-cat-orange"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M2 7.5h10a4 4 0 0 1 0 8H8"/><path d="M8 15.5L7 22"/><path d="M2 7.5v8h6"/></svg></span><b><?php echo $tfFr?'Coiffeuse':'Hairdresser'?></b></a>
        <a href="<?php echo $tfSvc('book_taxi')?>" class="tf-cat tf-cat-blue"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M4 13l1.8-5h12.4L20 13"/><path d="M3 13h18v5H3z"/><circle cx="7.5" cy="18" r="1.4"/><circle cx="16.5" cy="18" r="1.4"/></svg></span><b><?php echo $tfFr?'Réserver un taxi':'Book Taxi'?></b></a>
        <a href="<?php echo $tfSvc('hotel')?>" class="tf-cat tf-cat-orange"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M3 18V7"/><path d="M3 11h13a4 4 0 0 1 4 4v3"/><path d="M3 14h18"/><path d="M8 11V9h4v2"/></svg></span><b><?php echo $tfFr?'Réserver un hôtel':'Hotel'?></b></a>
        <a href="<?php echo $tfSvc('book_restaurants')?>" class="tf-cat tf-cat-orange"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M3.5 16a8.5 8.5 0 0 1 17 0"/><path d="M2 16h20"/><path d="M12 4.5V7"/></svg></span><b><?php echo $tfFr?'Réserver un restaurant':'Book Restaurants'?></b></a>
        ...
        <a href="<?php echo $tfSvc('grocery')?>" class="tf-cat tf-cat-green"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M3 4h2l2.2 11h10L20 7H6"/><circle cx="9" cy="19.5" r="1.4"/><circle cx="17" cy="19.5" r="1.4"/></svg></span><b><?php echo $tfFr?'Courses':'Grocery'?></b></a>
        ...
        <a href="<?php echo $tfSvc('takeout')?>" class="tf-cat tf-cat-green"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M6 8h12l-1 12H7z"/><path d="M9 8V6.5a3 3 0 0 1 6 0V8"/></svg></span><b><?php echo $tfFr?'À emporter':'Takeout'?></b></a>
      </div>
      <!-- tf-cat-grid -->
