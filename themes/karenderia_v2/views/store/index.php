  ...
  <div class="container-fluid" id="main-search-banner">
    <div class="tf-banner">
      ...
      <div class="tf-cat-grid">
        ...
        <a href="<?php echo $tfSvc('book_taxi')?>" class="tf-cat tf-cat-red"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M4 13l1.8-5h12.4L20 13"/><path d="M3 13h18v5H3z"/><circle cx="7.5" cy="18" r="1.4"/><circle cx="16.5" cy="18" r="1.4"/></svg></span><b><?php echo $tfFr?'Réserver un taxi':'Book Taxi'?></b></a>
        <a href="<?php echo $tfSvc('hotel')?>" class="tf-cat tf-cat-green"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M3 18V7"/><path d="M3 11h13a4 4 0 0 1 4 4v3"/><path d="M3 14h18"/><path d="M8 11V9h4v2"/></svg></span><b><?php echo $tfFr?'Réserver un hôtel':'Hotel'?></b></a>
        <a href="<?php echo $tfSvc('book_restaurants')?>" class="tf-cat tf-cat-blue"><span class="tf-cat-ico"><svg viewBox="0 0 24 24"><path d="M3.5 16a8.5 8.5 0 0 1 17 0"/><path d="M2 16h20"/><path d="M12 4.5V7"/></svg></span><b><?php echo $tfFr?'Réserver un restaurant':'Book Restaurants'?></b></a>
